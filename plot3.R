...
with(subsetdata, plot(NewDate, Sub_metering_1, type="l", xlab="Day", ylab="Energy sub metering"))
lines(subsetdata$NewDate, subsetdata$Sub_metering_2,type="l", col= "red")
lines(subsetdata$NewDate, subsetdata$Sub_metering_3,type="l", col= "blue")
